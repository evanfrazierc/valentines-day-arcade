...
let gameTime = 0;
let notesSpawned = 0;
let totalNotes = 175; // Total notes in the song (extended to match 3:53 duration)
let feedbackText = '';
let feedbackTime = 0;
let feedbackColor = '';
...
const beatPattern = [
    ...
    // Final stretch - maintaining challenge
...
function saveHighScore(score) {
    ...
    if (score > currentHigh) {
        localStorage.setItem('mazeHighScore', score.toString());
        highScore = score;
